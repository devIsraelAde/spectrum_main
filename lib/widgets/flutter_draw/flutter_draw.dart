...
class FlutterDraw extends StatefulWidget {
  @override
  _FlutterDrawState createState() => _FlutterDrawState();
}

class _FlutterDrawState extends State<FlutterDraw> {
  ...
  Widget paintScreen() {
    return RepaintBoundary(
      key: globalKey,
      child: Container(height: MediaQuery.of(context).size.height, child: Painter(_controller)),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Material(
      child: Column(
        children: <Widget>[ColorsList(gradients), Expanded(child: paintScreen())],
      ),
    );
    // return Scaffold(
    //   appBar: AppBar(
    ...
    //       },
    //       child: Container(
    //           padding: EdgeInsets.symmetric(horizontal: 16), alignment: Alignment.center, child: Icon(Icons.close)),
    //     ),
    //     title: Text(
    //       "Draw",
    ...
    //         },
    //         child: Container(
    //             padding: EdgeInsets.symmetric(horizontal: 16), alignment: Alignment.center, child: Icon(Icons.check)),
    //       ),
    //     ],
    //   ),
